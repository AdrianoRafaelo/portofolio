...
export default function LocationPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="floating-code">{"const express = require('express');"}</div>
      <div className="floating-code">{"app.get('/api/users', (req, res) => {"}</div>
      <div className="floating-code">{"SELECT * FROM projects WHERE active = 1;"}</div>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="py-16 md:py-24 border-b border-border bg-card/10 backdrop-blur-xs">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              <h1 className="text-4xl md:text-5xl font-bold gradient-text mb-4">Location</h1>
              <p className="text-lg text-muted-foreground">
                Based in Tarutung, Indonesia. Always open to collaborating with teams remotely or meeting in person.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Location Content */}
        <section className="py-16 md:py-24 bg-card/5 backdrop-blur-xs">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col gap-8">
                <div className="rounded-lg border border-border overflow-hidden bg-card h-96 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-1">Tarutung, Indonesia</h4>
                      <p className="text-sm text-muted-foreground">North Sumatra, Indonesia</p>
                    </div>
                  </div>
                </div>
